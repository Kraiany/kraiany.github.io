# Як додавати нові новини на сторінку
...
Довільний текст англійською мовою, слова розділені дефісами ('-').
...
яка записана в назві файлу, потрібно вказати час події і часовий пояс
UTC.
